		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "developer diary fiori app",
									"targetURL": "#fiorinamespacesapfiorideveloper-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fiorinamespacesapfiorideveloper-display": {
								"semanticObject": "fiorinamespacesapfiorideveloper",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fiorinamespace.sapfiorideveloper",
									"url": sap.ui.require.toUrl("fiorinamespace/sapfiorideveloper")
								}
							}
						}
					}
